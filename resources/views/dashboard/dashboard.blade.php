...
@push('css')
    ...
    <style>
        ...
        .bg-analytics {
            background : -webkit-linear-gradient(332deg, #1FBAD6, rgba(31, 186, 214, 0.7));
            background :         linear-gradient(118deg, #1FBAD6, rgba(31, 186, 214, 0.7));
        }
        .bg-analytics .avatar {
            margin-bottom : 2rem;
        }
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex flex-column align-items-start pb-0">
                        ...
                        <h2 class="text-bold-700 mt-1 mb-25">{{ number_format($stats['topups_total'],2).' '.\App\System::me()['reloadly_currency'] }}</h2>
