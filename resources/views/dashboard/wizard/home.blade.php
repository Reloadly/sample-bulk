                ...
                <div class="card-content pt-2 h-100">
                    <div class="card-body h-100">
                        <div class="row h-100 justify-content-center align-items-center">
                            <a href="#" data-toggle="modal-feed" data-target="#modal_sm" data-feed="/wizard/template">
                                <div class="col-auto">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @switch($file['status'])
                                                    ...
                                                    @break
                                                    @case('START')
                                                        <a class="btn btn-sm round btn-primary" href="/wizard/start/file/{{$file['id']}}">Start</a>
                                                    @break
                                                    @case('DONE')
